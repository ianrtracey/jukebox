...
public class JukeBoxTest {
	...
	public void testStudentCollectionAddAndLookup() {
		...
		Student student1 = new Student("Chris", 1);
		...
		Student queriedStudent = studentCollection.get("Chris");
		assertTrue(queriedStudent.getId() == "Chris" && queriedStudent.getPassword() == 1);
	...
	public void testJukeboxLogin() {
		...
		assertFalse(students.add(new Student("Chris", 1)));
		...
		assertFalse(jukebox.login("Chri", "1"));
		assertFalse(jukebox.login("Chri", "10"));
		assertTrue(jukebox.login("Chris", "1"));
	...
	public void testJukeBoxSize() {
		...
		jukebox.queue(new Song("tests", "tst", "flute.aif", 12));
